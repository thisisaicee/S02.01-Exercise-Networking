...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherData() {
        ...
        new FetchWeatherTask().execute(weatherLocation);
    }
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... data) {
            String partData = data[0];

            try {
                String[] jsonWeatherData = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, NetworkUtils.getResponseFromHttpUrl(NetworkUtils.buildUrl(partData)));
